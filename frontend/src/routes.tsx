...
import EditarHabitacion from "./features/Habitaciones/page/EdithabitacionPage";
import PersonalPage from "./features/Personal/page/PersonalPage";
    ...
    <BrowserRouter>
      <Routes>
        ...
        <Route element={<BaseInterfaz />}>
          ...
          <Route path="/reservaciones" element={<ReservacionesPage />}></Route>
          <Route
            path="/reservacion/:id/confirmacion"
