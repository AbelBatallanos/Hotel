...
export default function Habitaciones({
  ...
  const { habitacionesList, existHabitacion, eliminarHabitacion } =
    useAppStore();
      ...
      <div className="p-4 md:p-8 bg-slate-50 min-h-screen">
        ...
        <div className="mb-12 text-center max-w-2xl mx-auto">
          ...
          <p className="text-slate-500 text-lg leading-relaxed">
            Cada habitación ha sido diseñada meticulosamente para ofrecer una
            estancia de ensueño con los más altos estándares de calidad.
          </p>
        </div>
            ...
            >
              ...
              <div className="relative h-72 overflow-hidden">
                ...
                <div className="absolute top-6 left-6">
                  <span
                    className={`flex items-center gap-1.5 px-4 py-1.5 rounded-full text-[10px] font-semibold uppercase tracking-tighter backdrop-blur-md shadow-lg ${
                ...
                <div className="mt-auto">
                  {!existHabitacion(hab.id) ? (
                    <button
                      ...
                      className={`w-full group/btn flex justify-center items-center py-4 rounded-2xl font-black uppercase text-xs tracking-widest transition-all duration-300 ${"bg-slate-900 text-white hover:bg-emerald-600 shadow-xl shadow-slate-200 hover:shadow-emerald-200"}`}
                    >
                      {hab.estado.toLowerCase() === "disponible" ? (
